...
---
### 5. `POST /quality-flags-from-csv` – новый эндпоинт для детального анализа проблем датасета

Эндпоинт, реализованный в рамках HW04:

- принимает CSV-файл;
- возвращает полный набор булевых флагов качества данных, включая дополнительные эвристики из EDA-ядра.
